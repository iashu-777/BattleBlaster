...
void ABasePawn::RotateTurret(FVector LookAtTarget)
{
	...
	FRotator InterpolatedRotation= FMath::RInterpTo(TurretMesh->GetComponentRotation(),
		...
		10.0f
	); //function give new vector  after interpolation as previously fast rotation makes turret movement slight ugly
...
{
	UE_LOG(LogTemp,Display,TEXT("Handle BasePawnDestruction"))
}
